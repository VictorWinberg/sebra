import{i as t,k as r,l as i,q as c,m as s}from"./index-CR1gxfLo.js";import{p as n,u as a}from"./object-TfJ8iY93.js";const _=async()=>await c(`
    SELECT
      assignments.*,
  ...
  `),o=async e=>{await t("assignments",n(e,["assignmentName","responsiblePersonId","externalContactPersonId","relevantFiles","fee","type","status"]))},m=async e=>{await r("assignments",n(e,["assignmentName","responsiblePersonId","externalContactPersonId","relevantFiles","fee","type","status"]),n(e,["assignmentId"]))},p=async({assignmentId:e})=>{await i("assignments",{assignmentId:e})},y=()=>{const e=s();return a({mutationFn:o,onSuccess:()=>{e.invalidateQueries({queryKey:["assignments"]})}})},d=()=>{const e=s();return a({mutationFn:m,onSuccess:()=>{e.invalidateQueries({queryKey:["assignments"]})}})},g=()=>{const e=s();return a({mutationFn:p,onSuccess:()=>{e.invalidateQueries({queryKey:["assignments"]})}})};export{d as a,g as b,_ as f,y as u};
